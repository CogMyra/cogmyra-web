          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-12 px-6 py-12 lg:flex-row lg:items-center lg:py-20">
            ...
            <div className="max-w-xl">
              ...
              <div className="mt-7 flex flex-wrap items-center gap-4">
                <Link
                  to="/guide"
                  className="inline-flex items-center rounded-full bg-[#8AB0AB] px-6 py-2.5 text-sm font-medium text-[#03120E] shadow-xl hover:opacity-90 transition"
                >
                  Try the Guide
                </Link>
                <a
                  href="#about"
                  className="text-sm font-medium text-slate-100 hover:text-slate-200"
                >
                  About CogMyra
                </a>
              </div>
            ...
            <div className="flex-1">
              <div className="mx-auto max-w-xl rounded-3xl border border-white/10 bg-[#020817] p-6 shadow-[0_30px_80px_rgba(0,0,0,0.65)]">
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div className="rounded-2xl border border-emerald-900/40 bg-[#26413C] px-4 py-3 text-sm leading-relaxed text-slate-50">
                    ...
                    <p>
                      ...
                      release oxygen for us to breathe. What part of that
                      process would you like to zoom in on?
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-5 flex justify-center gap-1">
                  ...
                  <span className="h-1.5 w-1.5 rounded-full bg-slate-600/60" />
                  <span className="h-1.5 w-1.5 rounded-full bg-slate-700/40" />
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="mx-auto max-w-6xl px-6 py-14">
            ...
            <p className="mt-4 max-w-3xl text-sm md:text-base text-slate-700">
              ...
              students, educators, and professionals. CogMyra is a collection of
              world-class educators, not a search engine.
            </p>
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              ...
              <div className="pillar-card">
                ...
                <p className="mt-3 text-sm text-slate-800 leading-relaxed">
                  ...
                  coach that remembers what you’ve already mastered and adapts
                  to your pace.
                </p>
              </div>
